    ...
    <div
        ...
        <div
            ...
            <div
                ...
                {{ strtoupper(substr($stagiaire->Fullname, 0, 1)) }}
            </div>
            <div class="min-w-0">
                <h2 class="text-lg sm:text-xl font-bold text-white truncate">{{ $stagiaire->Fullname }}</h2>
                <p class="text-xs sm:text-sm text-slate-400 mt-0.5 truncate">{{ $stagiaire->email }}</p>
            </div>
        </div>
        ...
        <div class="divide-y divide-white/5">
            <div class="px-5 py-3 sm:px-8 sm:py-4 flex items-center justify-between gap-4">
                ...
                <span class="text-xs sm:text-sm font-mono text-white">{{ $stagiaire->id }}</span>
            </div>
            <div class="px-5 py-3 sm:px-8 sm:py-4 flex items-center justify-between gap-4">
                <span class="text-xs sm:text-sm text-slate-400 flex items-center gap-2 shrink-0">
                    <svg class="w-3.5 h-3.5 sm:w-4 sm:h-4 text-violet-400" fill="none" stroke="currentColor"
                ...
                <span class="text-xs sm:text-sm font-medium text-white truncate">{{ $stagiaire->Fullname }}</span>
            </div>
            <div class="px-5 py-3 sm:px-8 sm:py-4 flex items-center justify-between gap-4">
                <span class="text-xs sm:text-sm text-slate-400 flex items-center gap-2 shrink-0">
                    <svg class="w-3.5 h-3.5 sm:w-4 sm:h-4 text-violet-400" fill="none" stroke="currentColor"
                ...
                <span class="text-xs sm:text-sm text-white truncate">{{ $stagiaire->email }}</span>
            </div>
            <div class="px-5 py-3 sm:px-8 sm:py-4 flex items-center justify-between gap-4">
                <span class="text-xs sm:text-sm text-slate-400 flex items-center gap-2 shrink-0">
                    <svg class="w-3.5 h-3.5 sm:w-4 sm:h-4 text-violet-400" fill="none" stroke="currentColor"
                ...
                <span class="text-xs sm:text-sm text-white">{{ $stagiaire->created_at->format('M d, Y – H:i') }}</span>
            </div>
        </div>
