...
@section('content')
    ...
    <div class="mb-6 sm:mb-8">
        ...
        <p class="text-slate-400 mt-1 text-xs sm:text-sm">Update the information for <span
                class="text-violet-400 font-medium">{{ $stagiaire->Fullname }}</span></p>
    </div>
    ...
    <div
        ...
        <form action="{{ route('stagiaires.update', $stagiaire->id) }}" method="post" class="space-y-5 sm:space-y-6">
            @method('PUT')
            @csrf
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="text" id="fullname" name="fullname" value="{{ $stagiaire->Fullname }}"
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="text" id="email" name="email" value="{{ $stagiaire->email }}"
