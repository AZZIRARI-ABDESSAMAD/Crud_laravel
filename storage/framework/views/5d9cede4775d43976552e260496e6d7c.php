<nav class="sticky top-0 z-50 backdrop-blur-xl bg-white/5 border-b border-white/10 shadow-lg shadow-purple-500/5">
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-14 sm:h-16">
            ...
            <a href="<?php echo e(route('stagiaires.index')); ?>" class="flex items-center gap-2 group">
                <div
...
<?php /**PATH /home/azzirari-abdessamad/Project/Project_Laravel/laravel_with_abdessamad/crud/resources/views/partiels/navbar.blade.php ENDPATH**/ ?>